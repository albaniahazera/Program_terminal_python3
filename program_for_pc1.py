import os, random, string, pyperclip, termcolor, math, sys, exitProgram, datetime, random
from termcolor import colored
from exitProgram import exitProgram1
...
def tools1():
    def penghitung():
        ...
        def penghitungUmur():
            print(colored("\t*PENGHITUNG UMUR*"))
            now = datetime.datetime.now()
            tahun_sekarang = now.year
            tahun = input(colored("\nMasukkan tahun kelahiran kamu: "))
            tahun1 = int(tahun)
            umur = tahun_sekarang - tahun1
            umur1 = str(umur)
            print(colored(f"\nUmur kamu saat ini adalah: {umur1}"))
            userinput = int(input(colored("\nPILIHAN------------------------------------------------- \n\n1.Kembali ke penghitung umur \n0.Keluar \n\nPilih: ", "blue")))
            os.system("cls")
            if (userinput == 1):
                penghitungUmur()
        ...
        while True:
            ...
            print(colored("7.Penghitung umur", "blue"))
    ...
    def password():
        ...
        def pembuatpassword2():
            def generate_password(length):
                # Kombinasi huruf kecil, huruf besar, angka, dan simbol
                all_characters = string.ascii_letters + string.digits + string.punctuation
                # Membuat password dengan panjang yang diinginkan
            ...
            print(colored("\n\t*PEMBUAT PASSWORD YANG PANJANGNYA SESUAI KEINGINANMU*", "blue"))
            length = int(input(colored("\nMasukkan panjang password yang diinginkan: ", "blue")))
            new_password = generate_password(length)
            print(colored(f"\nPassword baru Anda adalah: {new_password}", "blue"))
            save_password_to_file(new_password)
            print(colored("\nPassword telah disimpan di file passwords.txt", "blue"))
            userinput = int(input(colored("\nPILIHAN------------------------------------------------- \n\n1.Buat lagi password \n0.Keluar \n\nPilih: ", "blue")))
            os.system("cls")
            if (userinput == 1):
                pembuatpassword2()
        ...
        while True:
            ...
            print(colored("3.Password yang panjangnya sesuai keinginanmu", "blue"))
            userinput = int(input("0.Keluar \n\nPilih: "))
            os.system("cls")
            if (userinput == 1):
                pembuatpassword()
